...
class TodosPage extends StatelessWidget {
  ...
  get _buildBody => BlocBuilder<TodoBloc, TodoState>(builder: (context, state) {
  ...
  get _buildFloatingActionBar => FloatingActionButton(
        onPressed: () {
          sl<TodoBloc>()
              .add(AddTodoEvent(TodoModel('TITLE', 'DESCRIPTION', false)));
        },
      );
